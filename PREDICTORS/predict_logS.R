...
path <- paste(FPADMET_PATH, "/MODELS/model_logS_pubchem.rds", sep="")
fittedmodel <- readRDS(path)

path <- paste(FPADMET_PATH, "/MODELS/qrf_model_logS_pubchem.rds", sep="")
fittedqrfmodel <- readRDS(path)

# fittedmodel <- readRDS("MODELS/model_logS_pubchem.rds")
# fittedqrfmodel <- readRDS("MODELS/qrf_model_logS_pubchem.rds")
